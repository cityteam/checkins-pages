...
toc: true
permalink: stats_develop_cheatsheet.html
folder: stats/develop
---

## Introduction

This document provides a convenient place to record the configuration settings
you have chosen, such as usernames and passwords, URLs for the database and
